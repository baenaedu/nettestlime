...
def run_lime():
    """Seperate process that runs LimeSDR.
    """
...
def create_lime_process():
    process = Process(target=run_lime, args=())
    process.daemon = True
    return process
...
if __name__ == '__main__':
    ...
    lime_process = create_lime_process()
    lime_process.start()
    ...
    for ifname in netifaces.interfaces():
        ...
        for cfg in get_config_combinations(EXPCONFIG):
            ...
            if lime_process.is_alive():
                lime_process.terminate()
